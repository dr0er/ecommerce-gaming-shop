  ...
  return (
    <div className="flex flex-col gap-4 px-4">
      <form onSubmit={handleSubmit(handleLogin)}>
        ...
        <button className="hidden" type="submit" onClick={handleSubmit(handleLogin)}></button>
      </form>

      {/* REMEMBE ME AND RESET PASSWORD */}
      <div className="flex justify-between ">
        <Checkbox setCheckbox={setIsRememberMe} isCheckbox={isRememberMe} text={'Remember me'} />
